  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white selection:bg-cyan-500/30">
      ...
      <main className="relative flex items-center justify-center px-6 pt-32 pb-24">
        {/* Ambient glow */}
        <div className="absolute top-1/2 left-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/10 blur-[150px] pointer-events-none" />

        <div className="relative z-10 mx-auto max-w-[600px] text-center">
          {/* Animated Success Icon */}
          <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 shadow-[0_0_60px_rgba(16,185,129,0.3)]">
          ...
          <p className="mb-2 text-lg text-white/60">
            Cảm ơn bạn đã đặt tour. Chúng tôi sẽ liên hệ để xác nhận chi tiết
            chuyến đi trong thời gian sớm nhất.
          </p>

          <p className="mb-10 text-sm text-white/40">
            Mã đơn hàng: <span className="font-mono text-cyan-400">{orderCode}</span>
          </p>
